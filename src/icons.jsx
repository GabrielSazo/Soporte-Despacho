...
const iconPaths = {
  ...
  folder: (
    <>
      <path d="M3 6.5A2.5 2.5 0 0 1 5.5 4H10l2 2h6.5A2.5 2.5 0 0 1 21 8.5v9a2.5 2.5 0 0 1-2.5 2.5h-13A2.5 2.5 0 0 1 3 17.5z" />
    </>
  ),
  logout: (
    <>
  ...
  moon: <path d="M20.6 15.7A8.7 8.7 0 0 1 8.3 3.4 8.7 8.7 0 1 0 20.6 15.7Z" />,
  ...
  shield: (
    <>
      <path d="M12 3 20 6v5c0 5.3-3.4 8.4-8 10-4.6-1.6-8-4.7-8-10V6z" />
  ...
  ticket: (
    <>
      <path d="M4 5.5A2.5 2.5 0 0 1 6.5 3h11A2.5 2.5 0 0 1 20 5.5V9a2 2 0 0 0 0 4v5.5a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 18.5V13a2 2 0 0 0 0-4z" />
  ...
  users: (
    <>
      ...
      <path d="M16 5.5a3 3 0 0 1 0 5.7M17 14.5a4.5 4.5 0 0 1 3.5 4.3V20" />
    </>
  ),
};
